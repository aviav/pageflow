var pageflow_paged = (function (exports, Backbone, _$1, Marionette, $, I18n$1, ChildViewContainer, IScroll, jquery_minicolors, wysihtml5, Cocktail) {
  'use strict';
  ...
  function findTranslation(keys, options) {
    ...
    return _$1.chain(keys).reverse().reduce(function (result, key) {
      var unescapedTranslation = I18n$1.t(key, _$1.extend({}, options, {
        defaultValue: result
      }));
  ...
  var CollectionView = Marionette.View.extend({
    ...
    addItem: function addItem(item) {
      var view = new this.options.itemViewConstructor(_$1.extend({
        model: item
  ...
  var SortableCollectionView = CollectionView.extend({
    render: function render() {
      ...
      this.$el.sortable({
        ...
        delay: 200,
        update: _$1.bind(function (event, ui) {
          if (ui.item.parent().is(this.el)) {
            this.updateOrder();
          }
        }, this),
        receive: _$1.bind(function (event, ui) {
          var view = ui.item.data('view');
          this.reindexPositions();
          this.itemViews.add(view);
          this.collection.add(view.model);
        }, this),
        remove: _$1.bind(function (event, ui) {
          var view = ui.item.data('view');
          this.itemViews.remove(view);
  ...
  var ConfigurationEditorTabView = Marionette.View.extend({
    ...
    view: function view(_view, options) {
      this.inputs.add(new _view(_$1.extend({
        model: this.model,
  ...
  /* @lends TabView.prototype */
  {
    ...
    onRender: function onRender() {
      _$1.each(this.tabNames, function (name) {
    ...
    defaultTab: function defaultTab() {
      if (_$1.include(this.tabNames, this.options.defaultTab)) {
        return this.options.defaultTab;
      } else {
        return _$1.first(this.tabNames);
      }
    },
    ...
    _labelTranslationKeys: function _labelTranslationKeys(name) {
      var result = _$1.map(this.options.translationKeyPrefixes, function (prefix) {
        return prefix + '.' + name;
      });
  ...
  var ConfigurationEditorView = Marionette.View.extend({
    ...
    tab: function tab(name, callback) {
      this.tabsView.tab(name, _$1.bind(function () {
  ...
  _$1.extend(ConfigurationEditorView, {
    repository: {},
  ...
  var TableCellView = Marionette.ItemView.extend({
    ...
    attributeTranslationKeys: function attributeTranslationKeys(keyName) {
      return _$1(this.options.attributeTranslationKeyPrefixes || []).map(function (prefix) {
  ...
  var TableRowView = Marionette.View.extend({
    ...
    render: function render() {
      _$1(this.options.columns).each(function (column) {
        this.appendSubview(new column.cellView(_$1.extend({
          model: this.model,
          column: column,
          attributeTranslationKeyPrefixes: this.options.attributeTranslationKeyPrefixes
  ...
  var TooltipView = Marionette.ItemView.extend({
    ...
    show: function show(text, position, options) {
      ...
      this.visible = true;
      clearTimeout(this.timeout);
      this.timeout = setTimeout(_$1.bind(function () {
        var offsetTop;
        var offsetLeft;
  ...
  var inputView = {
    ...
    attributeTranslationKeys: function attributeTranslationKeys$1(keyName, options) {
      return attributeTranslationKeys(this.options.propertyName, keyName, _$1.extend({
    ...
    inlineHelpText: function inlineHelpText() {
      ...
      return _$1.compact([findTranslation(keys, {
        defaultValue: '',
        html: true
  ...
  var CheckBoxGroupInputView = Marionette.ItemView.extend({
    ...
    initialize: function initialize() {
      if (!this.options.texts) {
        if (!this.options.translationKeys) {
          ...
          this.options.translationKeys = _$1.map(this.options.values, function (value) {
            return translationKeyPrefix + '.' + value;
          }, this);
        }

        this.options.texts = _$1.map(this.options.translationKeys, function (key) {
          return I18n$1.t(key);
        });
      }
    },
    ...
    appendOptions: function appendOptions() {
      _$1.each(this.options.values, function (value, index) {
    ...
    save: function save() {
      ...
      _$1.each(this.ui.container.find('input'), function (input) {
    ...
    load: function load() {
      if (!this.isClosed) {
        _$1.each(this.options.values, function (value) {
  ...
  var ColorInputView = Marionette.ItemView.extend({
    ...
    onRender: function onRender() {
      this.ui.input.minicolors({
        changeDelay: 200,
        change: _$1.bind(function (color) {
    ...
    getSwatches: function getSwatches() {
      return _$1.chain([this.defaultValue(), this.options.swatches]).flatten().uniq().compact().value();
    },
  ...
  var SelectInputView = Marionette.ItemView.extend({
    ...
    initialize: function initialize() {
      if (this.options.collection) {
        this.options.values = _$1.pluck(this.options.collection, this.options.valueProperty);

        if (this.options.textProperty) {
          this.options.texts = _$1.pluck(this.options.collection, this.options.textProperty);
        } else if (this.options.translationKeyProperty) {
          this.options.translationKeys = _$1.pluck(this.options.collection, this.options.translationKeyProperty);
        }

        if (this.options.groupProperty) {
          this.options.groups = _$1.pluck(this.options.collection, this.options.groupProperty);
        } else if (this.options.groupTranslationKeyProperty) {
          this.options.groupTanslationKeys = _$1.pluck(this.options.collection, this.options.groupTranslationKeyProperty);
        }
      }
      ...
      if (!this.options.groups) {
        this.options.groups = _$1.map(this.options.groupTanslationKeys, function (key) {
          return I18n$1.t(key);
        });
      }
    ...
    initialize: function initialize() {
      ...
      if (this.options.collection) {
        if (this.options.descriptionProperty) {
          this.options.descriptions = _$1.pluck(this.options.collection, this.options.descriptionProperty);
      ...
      if (!this.options.descriptions) {
        this.options.descriptions = _$1.map(this.options.descriptionTanslationKeys, function (key) {
          return I18n$1.t(key);
        });
      }
    },
  ...
  var TextAreaInputView = Marionette.ItemView.extend({
    ...
    onRender: function onRender() {
      ...
      this.editor.on('change', _$1.bind(this.save, this));
      this.editor.on('aftercommand:composer', _$1.bind(this.save, this));
    },
    onClose: function onClose() {
    ...
    setupUrlLinkPanel: function setupUrlLinkPanel() {
      this.editor.on('show:dialog', _$1.bind(function () {
  ...
  /** @lends UrlInputView.prototype */
  {
    ...
    validate: function validate(success) {
      ...
      if (options.required && !value) {
        ...
        displayValidationError(I18n$1.t('pageflow.ui.views.inputs.url_input_view.supported_vendors') + _$1.map(view.supportedHosts(), function (url) {
          return '<li>' + url + '</li>';
        }).join(''));
      } else {
      ...
      function hasSupportedHost(url) {
        return _$1.any(view.supportedHosts(), function (host) {
  ...
  function template$6$1(data) {
    ...
    __p += '<a class="back">' + ((__t = I18n.t('pageflow.editor.templates.edit_chapter.outline')) == null ? '' : __t) + '</a>\n<a class="destroy">' + ((__t = I18n.t('pageflow.editor.templates.edit_chapter.destroy')) == null ? '' : __t) + '</a>\n\n<div class="failure">\n  <p>' + ((__t = I18n.t('pageflow.editor.templates.edit_chapter.save_error')) == null ? '' : __t) + '</p>\n  <p class="message"></p>\n  <a class="retry" href="">' + ((__t = I18n.t('pageflow.editor.templates.edit_chapter.retry')) == null ? '' : __t) + '</a>\n</div>\n\n<div class="form_container"></div>';
    return __p;
  }
  ...
  function template$o(data) {
    ...
    __p += '<a class="back">' + ((__t = I18n.t('pageflow.editor.templates.edit_page.outline')) == null ? '' : __t) + '</a>\n<a class="destroy">' + ((__t = I18n.t('pageflow.editor.templates.edit_page.destroy')) == null ? '' : __t) + '</a>\n\n<div class="failure">\n  <p>' + ((__t = I18n.t('pageflow.editor.templates.edit_page.save_error')) == null ? '' : __t) + '</p>\n  <p class="message"></p>\n  <a class="retry" href="">' + ((__t = I18n.t('pageflow.editor.templates.edit_page.retry')) == null ? '' : __t) + '</a>\n</div>\n\n<div class="page_type"></div>\n\n<div class="configuration_container"></div>';
    return __p;
  }
  ...
  function template$p(data) {
    ...
    __p += '<a class="back">' + ((__t = I18n.t('pageflow.editor.templates.edit_storyline.outline')) == null ? '' : __t) + '</a>\n<a class="destroy" data-tooltip-align="bottom right">\n  ' + ((__t = I18n.t('pageflow.editor.templates.edit_storyline.destroy')) == null ? '' : __t) + '\n</a>\n\n<div class="failure">\n  <p>' + ((__t = I18n.t('pageflow.editor.templates.edit_storyline.save_error')) == null ? '' : __t) + '</p>\n  <p class="message"></p>\n  <a class="retry" href="">' + ((__t = I18n.t('pageflow.editor.templates.edit_storyline.retry')) == null ? '' : __t) + '</a>\n</div>\n\n<div class="form_container"></div>\n';
    return __p;
  }
  ...
  function template$x(data) {
    ...
    __p += '<span class="file_thumbnail"></span>\n\n<span class="file_name"></span>\n<a class="select">' + ((__t = I18n.t('pageflow.editor.templates.file_item.select')) == null ? '' : __t) + '</a>\n\n<div class="actions">\n  <a class="settings" title="' + ((__t = I18n.t('pageflow.editor.templates.file_item.settings')) == null ? '' : __t) + '"></a>\n  <a class="confirm" title="' + ((__t = I18n.t('pageflow.editor.templates.file_item.confirm')) == null ? '' : __t) + '"></a>\n  <a class="retry" title="' + ((__t = I18n.t('pageflow.editor.templates.file_item.retry')) == null ? '' : __t) + '"></a>\n  <a class="remove" title="' + ((__t = I18n.t('pageflow.editor.templates.file_item.destroy')) == null ? '' : __t) + '"></a>\n  <a class="cancel" title="' + ((__t = I18n.t('pageflow.editor.templates.file_item.cancel')) == null ? '' : __t) + '"></a>\n</div>\n\n<div class="details">\n  <ul class="file_stage_items"></ul>\n\n  <div class="file_meta_data">\n    <table cellpadding="0" cellspacing="0">\n      <tbody class="attributes">\n      </tbody>\n      <tbody class="downloads">\n        <tr>\n          <th>' + ((__t = I18n.t('pageflow.editor.templates.file_item.source')) == null ? '' : __t) + '</th>\n          <td><a class="original" href="#" download target="_blank">' + ((__t = I18n.t('pageflow.editor.templates.file_item.download')) == null ? '' : __t) + '</a></td>\n        </tr>\n      <tbody>\n    </table>\n  </div>\n</div>\n';
    return __p;
  }
  ...
  var EntryPreviewView = Marionette.ItemView.extend({
    ...
    updateEmulationModeSupport: function updateEmulationModeSupport(permaId) {
      ...
      this.model.set('current_page_supports_emulation_mode', model && model.pageType().supportsPhoneEmulation());
    },
  ...
  editor$1.pageSelectionView = PageSelectionView;

  editor$1.registerEntryType('paged', {
